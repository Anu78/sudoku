  ...
  return (
    <div className="shortcut-overlay">
      ...
      <ul className="key-items">
        <li>
          <span className="keys">?</span> - show overlay
        </li>
        <li>
          <span className="keys">s</span> - solve board
        </li>
        <li>
          <span className="keys">r</span> - reset board
        </li>
        <li>
          <span className="keys">g</span> - generate new puzzle
        </li>
        <li>
          <span className="keys">h</span> - toggle board highlight
        </li>
        <li>
